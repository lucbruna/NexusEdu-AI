...
export default function Register() {
  ...
  return (
    <div className="min-h-screen gradient-bg flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute top-20 right-20 w-72 h-72 bg-purple-500/20 rounded-full blur-[100px] animate-pulse-glow" />
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-emerald-500/15 rounded-full blur-[120px] animate-pulse-glow" style={{ animationDelay: "2s" }} />
      ...
      <motion.div
        ...
        className="glass rounded-3xl p-10 w-[420px] shadow-2xl relative z-10"
      >
        <motion.div
        ...
        >
          ...
          <p className="text-slate-400">Cadastre-se no NexusEdu AI</p>
        </motion.div>
        ...
        <motion.button
          ...
          onClick={register}
          disabled={loading}
          className="w-full p-4 rounded-xl text-white font-semibold mt-6 btn-gradient disabled:opacity-50"
        >
          {loading ? (
        ...
        <motion.p
          ...
          onClick={() => navigate("/")}
        >
          Já tem conta? <span className="text-indigo-400 hover:text-indigo-300">Fazer login</span>
        </motion.p>
      </motion.div>
    </div>
  );
